...
Finding the Numerological Reduction (also known as finding the digital root or theosophical addition, Single-Digit Calculation, or Feng Shui Reduction) is a very common practice in Chinese culture, especially among practitioners of Feng Shui and Nine Star Ki numerology. In traditional Chinese metaphysics, all numbers are ultimately reduced to a single digit from 1 through 9. This is because of two ancient systems:
...
To calculate a personal life/lucky number using Feng Shui and your birth year:
    ...
    Step 3 (For Females): Add 5 to that single digit (or add 6 if born in 2000 or later), then reduce the sum to a single digit if necessary. 
